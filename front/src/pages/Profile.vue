        ...
        >
          ...
          <div class="relative bg-neutral rounded-2xl shadow-xl border border-black/5 dark:border-white/10 w-[340px] max-w-[90vw] overflow-hidden">
            ...
            <div class="text-center px-6 pb-6">
              ...
              <p class="text-sm text-tertiary leading-relaxed mb-4">如有问题或建议，欢迎通过 GitHub Issues 联系我们：</p>
              <div class="bg-black/5 dark:bg-white/5 rounded-lg py-3 px-4 flex items-center gap-2">
                <span class="text-sm font-medium text-primary select-all flex-1 text-center">https://github.com/xiehuang01/blank/issues</span>
                <button
                  @click="copyEmail"
...
const copyEmail = async () => {
  try {
    await navigator.clipboard.writeText('https://github.com/xiehuang01/blank/issues');
    copied.value = true;
