    ...
    <main class="md:hidden max-w-md mx-auto pt-6 px-6 space-y-10">
      ...
      <section class="space-y-4">
        ...
        <div class="grid grid-cols-4 gap-3">
          ...
          >
            <img
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuAlKz4qb-d4igGDqny56-uA1vK6Ei_rPNv55pAdpWlJHIBu58t-qTJHmA3XeKv_eS9R_PuvsaV9HG5HeBsXPNRguMmGXQBHpvt9vzxvOzVGO5HIOmO2YFGjxR6IIjVLHLg6XtG8M6RyQWhjqd9TWs2_TDs4xSonm0vL4z6LkSlAE_OIVML9aeSKopbclE9UH1WB7_Lr5Olg_DqF_FUQV6VrKGXD0PGn-hudoUmxm0za9aPSZ-h-YLoRDGAdJqjA6Sg7P_mGf6DhbXWY"
              alt="Collection 2"
              class="w-full h-full object-cover grayscale-[30%] opacity-90"
              referrerpolicy="no-referrer"
            />
        ...
        <div class="col-span-9 space-y-8">
          ...
          <section class="bg-neutral rounded-2xl p-6 shadow-sm border border-black/5 dark:border-white/5">
            ...
            <div class="grid grid-cols-6 gap-4">
              <div class="rounded-lg bg-black/5 dark:bg-white/5 overflow-hidden shadow-inner border border-black/10 dark:border-white/10 flex items-center justify-center p-2 aspect-square hover:shadow-md transition-shadow cursor-pointer">
                <img
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuBMKuwdrzd0kycg5QbGFmMJMDT8RsE6UNc85oboGn-Tofw_7BqW1Fr1AxqgdIPVAOliVNVYW_xxX0D9w4teG8vu716EueLdlhtDZNMzx4AmtF6xpsxUovOnN9vxwxh4HShX2hixpG3URlodGZn0CCfMvapoqBDQoMNPiYZ7qRUDV_u5MqQexSdA1w6diNCYt21t14DqvZwE3JkN7udert8x6WNdDwaS9gdJzPKoMDZmPcvKSVzXPcgpoOY3CCfVKFU3sqia8imIUDUG"
                  alt="Like 1"
                  class="w-full h-full object-cover grayscale-[30%] opacity-90"
              ...
              <div class="rounded-lg bg-black/5 dark:bg-white/5 overflow-hidden shadow-inner border border-black/10 dark:border-white/10 flex items-center justify-center p-2 aspect-square hover:shadow-md transition-shadow cursor-pointer">
                <img
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuACTQfqd5zXW2cKBxVnuuNO9i9sq9Pk5JxreFwtXeFdwc2pIGVpcU8BSfkdg66pV8mXppMTUSNe2TNBt-8TAoJ_2qqGJdzR_AFhAht55cKNTHZl4J9MiGOF0m0GQeEaxBa0yPxLxlEqKz087elMQkmKsxl-N_MVFnQRLbTNconhVSYMHMKpzscx-mjg_lrzPMKbISEr9Tkei_ZxplmcGlDa-zn-f5Au102bOzwcGfBXkE4OHYlcPjh2knYoakUw-Zw564zPDVLeUzRI"
                  alt="Like 5"
                  class="w-full h-full object-cover grayscale-[30%] opacity-90"
                  referrerpolicy="no-referrer"
                />
          ...
          <section class="bg-neutral rounded-2xl p-6 shadow-sm border border-black/5 dark:border-white/5">
            ...
            <div class="grid grid-cols-6 gap-4">
              <div class="rounded-lg bg-[#F9F6F0] dark:bg-black/20 overflow-hidden shadow-sm border border-black/5 dark:border-white/5 p-4 flex items-center justify-center aspect-square hover:shadow-md transition-shadow cursor-pointer">
                <img
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuCCuA3ITyTjAAZHjpQdzaxoz_Fj7kS8s9bOqSMfo-b5rvYDRkx_lu9zS2SxSNHmBa21d22iOl1aI2XH0Wrh5eAYkrdMxSzPP-wxXFxoncAURrZUo0mhvigfEtR2T3YlGUj3dyvyRED-j2jrpg1X1Ua9HyJr8qCcJlehFYuuxoCubfWAImXJg3acTqnNozdo7U7MJ9DVEXr0Pb15BXDW8B9S1JPVIIIQbXZoW3A39xaIQyBXE3ZRs6yMdwpiVAFVgJfJSL-JlRnV4hjr"
                  alt="Stamp 1"
              ...
              <div class="rounded-lg bg-[#F9F6F0] dark:bg-black/20 overflow-hidden shadow-sm border border-black/5 dark:border-white/5 p-4 flex items-center justify-center aspect-square hover:shadow-md transition-shadow cursor-pointer">
                <img
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuBpQB1UjhAO6vKRAmMCZ3S-ZXr4gDQlqg5p_W8s3VQpSmvRI8ZFWb77GoNBv1pQSFrp29yzGKO7ToSmCsWu9eNOaU_yX73rDlmxzzYR-EYGqNvFUE9GU6-pML47z4gssxtjKw_D_hu5YoklvsjsZ5dZrTS2IeRIP-gSHZcX3uPab0dieLB1NT001ypZsLjEHGBoDGCLhP1xeR5D_2qEjeG2fSwr4mRFlZdTvCOPQXRPk_odlghJSqkYkSEVqyTj6SUXh89WxKOTVryA"
                  alt="Stamp 4"
                  class="w-full h-full object-cover filter sepia-[0.2] contrast-[0.9]"
                  referrerpolicy="no-referrer"
                />
              ...
              <div class="rounded-lg bg-[#F9F6F0] dark:bg-black/20 overflow-hidden shadow-sm border border-black/5 dark:border-white/5 p-4 flex items-center justify-center aspect-square hover:shadow-md transition-shadow cursor-pointer">
                <img
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuBd6X2WJj88uA-1RVrxPORBU5AZOzg0nPJE0215heBs15OL-FE5V0Emhxn5a0nfklc9t6clO3mSiIjAFO0I0Mu6Y2NWyuafRtrW3L14crLdzu4cKDxHP18lUsiFqiPeocxG9WI6YO4O4sNEKukHmVSUdMlVnvlI-UWmX3fegWKNND6QcgHxDuYmLtaJ0Wtz_zWoy5sgdMRBUu-O97TbNR-8JnQ8bWqrJpMMyC0G6wyiLUlrmBrDU1-IrnmebQHtx7qpfUFYV-XhueBQ"
                  alt="Stamp 5"
                  class="w-full h-full object-cover filter sepia-[0.2] contrast-[0.9]"
                  referrerpolicy="no-referrer"
                />
              </div>
              <div class="rounded-lg bg-black/5 dark:bg-white/5 overflow-hidden shadow-inner border border-black/10 dark:border-white/10 flex items-center justify-center p-4 aspect-square hover:shadow-md transition-shadow cursor-pointer">
                <div class="w-full h-full bg-black/5 dark:bg-white/5 flex items-center justify-center border-2 border-dashed border-black/20 dark:border-white/20 rounded-lg">
                  <Plus class="text-tertiary w-8 h-8" />
                </div>
              </div>
