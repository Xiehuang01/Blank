    ...
    <div class="w-full max-w-2xl relative h-[600px]">
      ...
      <div class="relative w-full h-full">
        ...
        >
          <div class="w-full h-full p-3 flex">
            <div class="flex-1 relative border border-black/5 dark:border-white/5 overflow-hidden">
              <div class="w-full h-full bg-gradient-to-br from-amber-100 via-orange-50 to-yellow-200 dark:from-amber-900/30 dark:via-orange-900/20 dark:to-yellow-900/30 flex items-center justify-center">
        ...
        >
          <div class="w-full h-full p-3 flex">
            <div class="flex-1 relative border border-black/5 dark:border-white/5 overflow-hidden">
              <div class="w-full h-full bg-gradient-to-br from-blue-100 via-cyan-50 to-teal-200 dark:from-blue-900/30 dark:via-cyan-900/20 dark:to-teal-900/30 flex items-center justify-center">
                <span class="text-6xl select-none">📮</span>
              </div>
            </div>
          </div>
